...
<Row>
    <Col>
        <Figure src={riversOrder} alt="" caption="Figure 3. The Wairoa catchment in Hawkes Bay, showing CMUs (defined by white boundaries) as well as the main (stream order 3 and higher) branches of the Wairoa River." />
    </Col>
    <Col>
    </Col>
</Row>
