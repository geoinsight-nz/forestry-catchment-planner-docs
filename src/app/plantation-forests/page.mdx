...
With reference to forestry harvesting cycles we can determine the age of the plantation with the aim of showing where clearfell harvesting is predicted to happen at any time in the future. In this way, we can show how much land will be in the window of vulnerability and where it will be located.
