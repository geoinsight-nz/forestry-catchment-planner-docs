...
import erosionSusceptibility from './_images/erosion_susceptibility.png'
...
<Figure src={erosionSusceptibility} caption="Erosion susceptibility in Hawke's Bay assessed within the Forestry Catchment Planner." />
