import geoinsightDark from './_images/geoinsight_dark.webp'
import geoinsightLight from './_images/geoinsight_light.png'

import gnsLight from './_images/gns_light.png'
import gnsDark from './_images/gns_dark.png'

import induforDark from './_images/indufor_dark.png'
import induforLight from './_images/indufor_light.png'

import uc from './_images/uc.png'
...
<Grid>
    ...
    <ColumnRight>
        <Container>
            <Figure src={geoinsightLight} srcDark={geoinsightDark} alt="GeoInsight" zoom={false} />
        </Container>
    </ColumnRight>
    ...
    <ColumnRight>
        <Container>
            <Figure src={gnsLight} srcDark={gnsDark} alt="GNS Science" zoom={false} />
        </Container>        
    </ColumnRight>
    ...
    <ColumnRight>
        <Container>
            <Figure src={induforLight} srcDark={induforDark} alt="Indufor" zoom={false} />
        </Container>
    </ColumnRight>
    ...
    <ColumnRight>
        <Container>
            <Figure src={uc} alt="The University of Canterbury" zoom={false} />
        </Container>
    </ColumnRight>
</Grid>