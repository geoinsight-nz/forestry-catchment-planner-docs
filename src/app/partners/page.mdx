    ...
    <Col>
        <Properties>
            <Property name="Indufor">
                ...
                Indufors role in the project was to calculate forest stand ages and the spatial extents of the forest stands across Te Tauihu (Top of the South Island), Te Matau-a-Māui (Hawkes Bay), and Tairāwhiti (Gisborne).
            </Property>
            <Property name="GeoInsight">
            ...
            <Property name="The University of Canterbury">
