...
export const metadata = {
  title: 'Background',
  description:
    'New Zealand's plantation forests are highly effectively at preventing soil erosion. Erosion damage avoided as a result of plantation forests saves New Zealand nearly $1 billion annually.',
}
