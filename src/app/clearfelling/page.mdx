...
<Row>
    <Col>
        <Figure src={wov} alt="The window of vulnerability" caption="Typical changes in forest vegetation root strength or root reinforcement after timber harvesting showing the ‘window of vulnerability’, estimated to be in the period 1-6 years after harvesting, but this is species and density dependent. Source: Phillips et al. (2024)." />
    </Col>
    <Col>
    </Col>
</Row>
