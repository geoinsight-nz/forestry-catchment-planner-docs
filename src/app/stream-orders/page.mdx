import strahlerClassificationDark from './strahler_classification_dark.png'
import strahlerClassificationLight from './strahler_classification_light.png'
...
<Row>
    <Col>
        <Figure src={strahlerClassificationLight} srcDark={strahlerClassificationDark} alt="" caption="Figure 2. Stream order classification. Source: NIWA." />
    </Col>
    <Col>
    </Col>
</Row>

| Network position (Refer to [Figure 1](/depositional-zones#river-environments)) | Order     | Gradient     | Landforms                     | Dominant process  |
|-----------------------------------|-----------|--------------|-------------------------------|-------------------|
