...
import hsu from './_images/hsu.png'

export const metadata = {
  title: 'Hill Slope Units',
  description:
    'Within each Catchment Management Unit, an area is divided up into multiple hillslope units (HSUs).',
}
...
<Figure src={hsu} alt="" caption="Figure 4. Hill Slope Units and Catchment Management Units within the Ruatoria Forest catchment." />
