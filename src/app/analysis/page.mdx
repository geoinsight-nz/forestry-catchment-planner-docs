...
import landslideSusceptibility from './hsu_wairoa.png'
    ...
    images={[
        {
            src: tolagaBay,
            alt: 'Tolaga Bay.',
            caption: 'Tolaga Bay area of Gisborne.',
        },
        {
            src: marlboroughSounds,
            alt: 'Marlborough Sounds and South Marlborough.',
            caption: 'Marlborough Sounds and South Marlborough.',
        },
    ]}
/>
...
|-----------------|--------------------------------------------------------------------------------------------------------|
| LCC1            | Forest: Group 1 includes: indigenous forest, deciduous hardwoods, exotic forest and harvested forest.  |
| LCC2            | Scrub and grassland: Group 2 includes: alpine vegetation, scrub, and grassland/pasture.                |
| LCC3            | Bare ground and Urban: Group 3 includes: bare ground, horticulture, urban, urban open (parks and open space), transport and landslides. |
| LCC0            | Water or Swamp                                                                                         |
