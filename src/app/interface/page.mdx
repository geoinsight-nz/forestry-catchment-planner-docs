...
import 3DMode from './3D_mode.png'
...
export const sections = [
  ...
  { title: 'Measuring an area', id: 'measure-an-area' },
  { title: 'Measuring a distance', id: 'measure-an-distance' },
  { title: 'Measuring a distance', id: 'measure-an-distance' },
  { title: 'Measuring an elevation', id: 'measure-an-elevation' },
  { title: 'Calculating a gradient', id: 'calculate-a-gradient' },
...
<Figure src={3DMode} srcDark={3DMode} alt="Switch between 2D and 3D mode." />
...
<Figure src={layersControl} srcDark={layersControl} alt="Toggle layers from the layers menu." />
