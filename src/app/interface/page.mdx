...
import measureDistanceLight from './measureDistanceLight.png'
import measureDistanceDark from './measureDistanceDark.png'
import measureAreaLight from './measureAreaLight.png'
import measureAreaDark from './measureAreaDark.png'
...
Below you will find details and descriptions of the various features and components of the Forestry Catchment Planner application interface. {{ className: 'lead' }}
...
<Figure src={measureDistanceLight} srcDark={measureDistanceDark} alt="Measure a distance on the map." />
