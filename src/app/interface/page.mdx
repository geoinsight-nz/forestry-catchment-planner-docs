...
## Measure an elevation profile along a line
...
## Calculate a gradient between two points
...
<Figure src={3DMode} srcDark={3DMode} alt="Measure a gradient of elevation." />
...
<Figure src={featureLight} srcDark={featureDark} alt="Multi select modal." />
