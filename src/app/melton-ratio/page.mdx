...
import meltonRatio from './_images/fcp_melton_ratio_figure.png'
...
<Figure src={meltonRatio} alt="Melton ratio" caption="Calculation of the Melton-R for a steep catchment (red area). Example illustration based on excerpt from Melton, M. A. (1965). The geomorphic and paleoclimatic significance of alluvial deposits in southern Arizona. The Journal of Geology, 1-38." />
