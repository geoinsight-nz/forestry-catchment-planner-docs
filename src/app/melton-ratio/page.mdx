...
import meltonRatio from './melton_ratio.png'
...
1. steep channel slopes combined with availability of large volumes of sediment for mobilisation, either on slopes or in a stream channel; 
2. rainfall and/or streamflow of sufficient intensity to mobilise the sediment. 
...
<Row>
    <Col>
        <Figure src={meltonRatio} alt="" caption="Figure 7. Calculation of the Melton-R for a steep catchment (red area) above an alluvial fan (middle yellow area). Source: https://www.kingcounty.gov/services/environment/water-and-land/flooding/maps/river-landslide-hazards/mapping-methodologies.aspx, downloaded 1 March 2021." />
    </Col>
    <Col>
    </Col>
</Row>
